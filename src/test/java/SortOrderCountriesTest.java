...
public class SortOrderCountriesTest {
    ...
    private By zonesSelected = By.xpath(".//td[3]//option[@selected='selected']");
...
//        на странице зайти в каждую из стран и проверить, что зоны расположены в алфавитном порядке
        ...
        checkCountriesWithZones(countZonesByZonesPage, zonesTable, zonesSelected, geoZonesButton, editPen);
    }
